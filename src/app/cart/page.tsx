...
function CartPage() {
                ...
                actions: [
                    {
                        ...
                        onClick: () => {
                            ...
                            showWarning("Undo Not Available", "Please re-add the item from the product page.");
                        },
                        variant: "primary"
                    }
                ]
    ...
    const handleCheckout = () => {
        if (items.length === 0) {
            showWarning("Empty Cart", "Please add some items to your cart before checking out.");
            return;
        }
        ...
        <div className="content-section text-center py-16">
            <div className="max-w-md mx-auto">
                ...
                <p className="text-gray-600 mb-8">
                    ...
                    Start shopping to find your perfect wig!
                </p>
                                    ...
                                    <div className="space-y-6">
                                        {items.map((item) => {
                                            ...
                                            return (
                                                <div
                                                    key={item.id}
                                                    className={`flex flex-col sm:flex-row gap-4 p-4 border border-gray-200 rounded-lg transition-opacity duration-200 ${itemLoading ? 'opacity-50' : ''
                                                        }`}
                                                >
                                                    {/* Product Image */}
                                                        ...
                                                        <div className="flex flex-col sm:flex-row sm:justify-between">
                                                            ...
                                                            <div className="flex items-center space-x-3">
                                                                <div className="flex items-center border border-gray-300 rounded-lg">
                                                                    ...
                                                                    <button
                                                                        onClick={() => handleQuantityChange(item.id, item.quantity + 1)}
                                                                        disabled={itemLoading || item.quantity >= 99}
                                                                        className="p-2 hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
