...
export default function ProductCard({
  ...
  const getAddToCartButtonStyles = () => {
    const baseStyles =
      "px-4 py-2 text-sm font-medium rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 transform touch-manipulation min-h-[44px] flex items-center justify-center"
  ...
  return (
    ...
    >
      ...
      <div className="p-4 flex flex-col flex-grow">
        ...
        {/* Rating */}
        {showRating && (
          <div className="mb-3">{renderStarRating(average_rating)}</div>
        )}
